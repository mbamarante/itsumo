/********COPY-AND-PASTE FROM RANDOMC.H *********************** 2001-10-24 AF *
*
...
std::string doubleToString(double d, int _precision);//fixed precision
...
//   enum TArch {LITTLE_ENDIAN, BIG_ENDIAN, NON_IEEE, EXTENDED_PRECISION_LITTLE_ENDIAN};
//   TArch Architecture;                  // conversion to float depends on computer architecture
// };
