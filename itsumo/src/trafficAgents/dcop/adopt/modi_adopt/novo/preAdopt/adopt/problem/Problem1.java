...
/* public Variable findNextPriority2(int[] map, Vector subTrees) {
	return new Variable();
}

  public PriorityTree priorityTree4() {
	PriorityTree order;
	Variable root = (Variable)vars.elementAt(3);
	order = new PriorityTree (root,3);
	PriorityTree st = new PriorityTree((Variable)vars.elementAt(1),1);
	PriorityTree st1 = new PriorityTree((Variable)vars.elementAt(0),2);
	PriorityTree st2 = new PriorityTree((Variable)vars.elementAt(4),2);
	PriorityTree st3 = new PriorityTree((Variable)vars.elementAt(2),2);
	PriorityTree st4 = new PriorityTree((Variable)vars.elementAt(5),2);
  ...
  private void removeZeroes(int[][] w, int noOfPartitions) {
  ...
  /* This function gets the middle node in the longest shortest path between any two nodes in the graph */
  		...
  		if(v[i] == 1) {
			for(int j = 0;j < vars.size() ;j++)
			{
				if(j != i && v[j] == 1)
				{
					...
					visited[i] = 1;
					path[0] = i;
					int pathLength = getShortestPath(i,j,v,path,1,visited);
 ...
 /*public PriorityTree priorityTree31() {
	  PriorityTree order = new PriorityTree((Variable)vars.elementAt(9));
	  PriorityTree st2 = new PriorityTree((Variable)vars.elementAt(0));
	  PriorityTree st3 = new PriorityTree((Variable)vars.elementAt(1));
	  PriorityTree st4 = new PriorityTree((Variable)vars.elementAt(2));
	  PriorityTree st5 = new PriorityTree((Variable)vars.elementAt(10));
	  PriorityTree st6 = new PriorityTree((Variable)vars.elementAt(4));
	  PriorityTree st7 = new PriorityTree((Variable)vars.elementAt(5));
	  PriorityTree st8 = new PriorityTree((Variable)vars.elementAt(3));
	  PriorityTree st9 = new PriorityTree((Variable)vars.elementAt(6));
	  PriorityTree st10 = new PriorityTree((Variable)vars.elementAt(7));
	  PriorityTree st11 = new PriorityTree((Variable)vars.elementAt(8));
	  PriorityTree st12 = new PriorityTree((Variable)vars.elementAt(11));
